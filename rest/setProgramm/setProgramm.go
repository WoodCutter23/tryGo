...
func SetProgramm(dbConnect string)  {
	http.HandleFunc("/setProgramm", func(w http.ResponseWriter, r *http.Request) {
		...
		_, err = db.Exec("UPDATE basic SET programm = ?, actual_programm = 0 WHERE controller_id = ?",
			data, id)
